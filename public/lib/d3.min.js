...
! function(t, n) {
    ...
    function we(t, n) {
        var e, r, i, o = me.lastIndex = xe.lastIndex = 0,
            ...
            c = [];
        for (t += "", n += "";
            (e = me.exec(t)) && (r = xe.exec(n));)(i = r.index) > o && (i = n.slice(o, i), u[a] ? u[a] += i : u[++a] = i), (e = e[0]) === (r = r[0]) ? u[a] ? u[a] += r : u[++a] = r : (u[++a] = null, c.push({
            i: a,
            x: _e(e, r)
        })), o = xe.lastIndex;
    ...
    var Ai = {
        ...
        ki = {
            name: "xy",
            handles: ["n", "w", "e", "s", "nw", "ne", "sw", "se"].map(Di),
            input: function(t) {
    ...
    function ja(t) {
        var n, e, r = void 0 === t.grouping || void 0 === t.thousands ? Fa : (n = Ia.call(t.grouping, Number), e = t.thousands + "", function(t, r) {
    ...
    function uf(t, n) {
        var e = af(n),
            ...
            o = [vu(e), -su(e), 0],
            a = 0,
            u = 0; of .reset(), 1 === i ? r = eu + Ja : -1 === i && (r = -eu - Ja);
    ...
    var dd = hd(function() {}, function(t, n) {
        t.setTime(+t + n)
    }, function(t, n) {
        return n - t
    });
    ...
    }, t.zoomIdentity = Wb, t.zoomTransform = Zb, Object.defineProperty(t, "__esModule", {
        value: !0
    })
});